...
{
    [LocalizedDisplayName(nameof(Resources.ExtractAllCharactersUntilWhiteSpace_DisplayName))]
    [LocalizedDescription(nameof(Resources.ExtractAllCharactersUntilWhiteSpace_Description))]
    public class ExtractAllCharactersUntilWhiteSpace : ContinuableAsyncCodeActivity
    {
        #region Properties
        ...
        [LocalizedDisplayName(nameof(Resources.ExtractAllCharactersUntilWhiteSpace_DisplayLog_DisplayName))]
        [LocalizedDescription(nameof(Resources.ExtractAllCharactersUntilWhiteSpace_DisplayLog_Description))]
        [LocalizedCategory(nameof(Resources.Options_Category))]
        public bool DisplayLog { get; set; }

        [LocalizedDisplayName(nameof(Resources.ExtractAllCharactersUntilWhiteSpace_DisplayRegex_DisplayName))]
        [LocalizedDescription(nameof(Resources.ExtractAllCharactersUntilWhiteSpace_DisplayRegex_Description))]
        [LocalizedCategory(nameof(Resources.Options_Category))]
        ...
        protected override async Task<Action<AsyncCodeActivityContext>> ExecuteAsync(AsyncCodeActivityContext context, CancellationToken cancellationToken)
        {
            ...
            string[] OutputResults = CallExtractions.CallExtractAllCharactersUntilWhiteSpace(inputText, anchorWords, displayLog, displayRegex);
