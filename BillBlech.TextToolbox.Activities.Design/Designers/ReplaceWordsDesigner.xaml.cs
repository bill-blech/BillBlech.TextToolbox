...
{
    /// <summary>
    /// Interaction logic for ReplaceWordsDesigner.xaml
    /// </summary>
    public partial class ReplaceWordsDesigner
    {
        string MyIDText = null;
        string MyArgument = null;

        public ReplaceWordsDesigner()
        {
            InitializeComponent();
        }
        ...
        private void OccurrencesComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                //Visible
                this.IndexOccurence.Visibility = Visibility.Visible;
            }
            else
            {
                //Hidden
                this.IndexOccurence.Visibility = Visibility.Collapsed;

                //Clear Field Value
                ModelProperty property = this.ModelItem.Properties["IndexOccurence"];
        ...
        private void Button_OpenPreview(object sender, RoutedEventArgs e)
        {
            ...
            string OccurencePosition = ReturnIndexOccurence();
            ...
            //ReplacedWord
            MyArgument = "Replaced Word";

            //Get Item from the Interface
            string MyReplacedWord = ReturnReplacedWord();
        ...
        private string ReturnIndexOccurence()
        {
            try
            {
                //Get the FilePath
                return this.IndexOccurence.Expression.ToString();
            }
            catch (Exception ex)
            {
        ...
        private string ReturnReplacedWord()
        {
            try
            {
                //Get the FilePath
                return this.ReplacedWord.Expression.ToString();
            }
            catch (Exception ex)
            {
