...
{
    /// <summary>
    /// Interaction logic for ExtractAllCharactersUntilWhiteSpaceDesigner.xaml
    /// </summary>
    public partial class ExtractAllCharactersUntilWhiteSpaceDesigner
    {

        string MyIDText = null;
        string MyArgument = null;

        public ExtractAllCharactersUntilWhiteSpaceDesigner()
        {
            InitializeComponent();
        }
        ...
        private void Button_OpenPreview(object sender, RoutedEventArgs e)
        {
            ...
            if (PercResults == 1)
            {
                ...
                DesignUtils.CallformPreviewExtraction(MyIDText, "Extract Text Until White Space", MyIDTextParent, encoding);
            }
            else
            {
                //Error Message
