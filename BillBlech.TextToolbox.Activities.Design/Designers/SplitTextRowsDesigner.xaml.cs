...
{
    /// <summary>
    /// Interaction logic for SplitTextRowsDesigner.xaml
    /// </summary>
    public partial class SplitTextRowsDesigner
    {
        ...
        private void Button_OpenPreview(object sender, RoutedEventArgs e)
        {
            ...
            if (MyEncoding != null)
            {
                ...
                string[] searchWords = { "FileName" + Utils.DefaultSeparator(), "Null Limit" + Utils.DefaultSeparator(), "Suppress Null Values" + Utils.DefaultSeparator() };
                ...
                if (PercResults == 1)
                {
                    ...
                    DesignUtils.CallformPreviewExtraction(MyIDText, "Split text Uneven Blank Spaces", MyIDText, encoding);
                }
                else
                {
                    //Error Message
        ...
        //Return NullLimit
        private string ReturnNullLimit()
        {
            try
            {
                //Get the FilePath
                return this.NullLimit.Expression.ToString();
            }
            catch (Exception ex)
            {
        ...
        //Return Suppress Null Values
        private string ReturnSuppressNullValues()
        {
            try
            {
                //Get the FilePath
                return this.bSuppressNulls.Expression.ToString();
            }
            catch (Exception ex)
            {
